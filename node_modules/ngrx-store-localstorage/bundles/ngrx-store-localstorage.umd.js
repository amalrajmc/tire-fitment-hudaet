(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngrx-store-localstorage', ['exports', 'deepmerge'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngrx-store-localstorage'] = {}, global.deepmerge));
    ...
    var deepmerge__namespace = /*#__PURE__*/_interopNamespace(deepmerge);
    ...
    var defaultMergeReducer = function (state, rehydratedState, action) {
        if ((action.type === INIT_ACTION || action.type === UPDATE_ACTION) && rehydratedState) {
            ...
            state = deepmerge__namespace(state, rehydratedState, options);
        }
        return state;
    };
